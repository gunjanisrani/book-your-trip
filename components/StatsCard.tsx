...
const StatsCard = ({
    ...
    const {trend,percentage} = calculateTrendPercentage(currentMonthCount, lastMonthCount); //calculates the trend percentage based on current and last month counts

    const isDecrement = trend === "decrement";  //turning the trend into a boolean value to check if the trend is decrement or not
